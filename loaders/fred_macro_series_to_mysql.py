...
SERIES_CONFIG = [
    ...
    },
    {
        ...
        "series_info": {
            "series_code": "DFEDTAR",
            "series_name": "Federal Funds Target Rate",
            "category_name": "미국 매크로",
            "country_code": "US",
            "macro_category": "정책금리",
            "indicator_code": "US_DFEDTAR",
            "indicator_name_ko": "기준금리 목표 상단(구체계)",
            "indicator_name_en": "Federal Funds Target Rate",
            "is_macro_tracker": False,
            "display_order": 9001,
            "is_active": True,
            "frequency": "daily",
            "unit": "%",
            ...
            "default_color": None,
            "is_recession_series": False,
            "notes": "FRED API 적재 | 정책 국면 계산용 | 2008-12-15 이전 target rate",
            "source_series_code": "DFEDTAR",
            "source_series_name": "Federal Funds Target Rate",
            "transform_code": "fred_api",
            "transform_name": "RAW",
            "is_transformed": False,
            "source_unit": "Percent",
    ...
    },
    {
        "series_id": "DFEDTARU",
        "series_info": {
            "series_code": "DFEDTARU",
            "series_name": "Federal Funds Target Range - Upper Limit",
            "category_name": "미국 매크로",
            "country_code": "US",
            "macro_category": "정책금리",
            "indicator_code": "US_DFEDTARU",
            "indicator_name_ko": "기준금리 목표 상단",
            "indicator_name_en": "Federal Funds Target Range - Upper Limit",
            "is_macro_tracker": False,
            "display_order": 9002,
            "is_active": True,
            "frequency": "daily",
            ...
            "default_color": None,
            "is_recession_series": False,
            "notes": "FRED API 적재 | 정책 국면 계산용 | 2008-12-16 이후 target range upper limit",
            "source_series_code": "DFEDTARU",
            "source_series_name": "Federal Funds Target Range - Upper Limit",
            "transform_code": "fred_api",
            "transform_name": "RAW",
            "is_transformed": False,
            "source_unit": "Percent",
